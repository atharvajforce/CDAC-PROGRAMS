...
public class TestArray2D {
	...
	public static void main(String[] args) {
		...
		System.out.println("13. rotate matrix  column right   \n14. convert to 1D array\n15. exit\nchoice : ");
		choice=sc.nextInt();
		switch(choice) {
		case 1:
		...
		case 12:
			...
			break;
		case 13:
			System.out.println("Enter number of rotation for right column");
			n=sc.nextInt();
			newarr=Array2DService.rotateColumnLeft(arr,n);
			Array2DService.displayData(newarr);
			break;	
		case 14:
